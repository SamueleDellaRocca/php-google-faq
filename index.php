...
$arrayDomRisp = [
    ...
    [
        ...
        <p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <a href='#'>Centro Google per la sicurezza online</a>.
        </p>
    ...
    [
        'domanda' => "<h1>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h1>",
    ...
    [
        'domanda' => "<h1>Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?
        </h1>",
